...
const DropdownMenu = ({ taskId, handleDelete, projectId, setRenderChange, projectTasks }) => {
    ...
    return (
        <>
            ...
            <AddTaskModal isAddTaskModalOpen={isEditTaskModalOpen} setAddTaskModal={setEditTaskModal} projectId={projectId} taskId={taskId} edit={true} refreshData={refreshData} projectTasks={projectTasks} />
        </>
    )
}
